...
MACRO(SetDebug)
	...
	ELSE()
		SET(CMAKE_C_FLAGS "-g3 -D_DEBUG -DDEBUG -DPOSIX -DLINUX -finput-charset=GB2312 -fexec-charset=UTF-8")
		SET(CMAKE_CXX_FLAGS "-g3 -D_DEBUG -DDEBUG -DPOSIX -DLINUX -finput-charset=GB2312 -fexec-charset=UTF-8")
	ENDIF()
ENDMACRO(SetDebug)
...
MACRO(SetOutputCfg)
    IF(MSVC)
	    SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${PRJOUTPUT})
		SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${PRJOUTPUT})
		SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${PRJOUTPUT})
	ELSEIF(ANDROID)
	    SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${PRJOUTPUT}/libs/armeabi)
		SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${PRJOUTPUT}/lib/armeabi)
		SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${PRJOUTPUT}/bin)
	ELSE()
		SET(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${PRJOUTPUT}/lib)
		SET(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${PRJOUTPUT}/lib)
		SET(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${PRJOUTPUT}/bin)
	ENDIF()
